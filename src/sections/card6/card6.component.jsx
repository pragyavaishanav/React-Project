...
class Card6 extends React.Component {
  constructor() {
    ...
    this.state = {
      tablist: [
        { tabItem: "erp", classname: "current", index: 0 },
        { tabItem: "cmms", classname: "", index: 1 },
        { tabItem: "work instructions", classname: "", index: 2 },
        { tabItem: "bi tools", classname: "", index: 3 },
        { tabItem: "communications", classname: "", index: 4 },
      ],
      ...
      tabcontent: [
        {
          ...
          imageTab: [
            ...
            {
              image:
                "https://www.machinemetrics.com/hubfs/globalshopsolutions_logo.png",
            },
          ],
        },
        {
        ...
        },
        {
          ...
          imageTab: [
            ...
            {
              image:
                "https://www.machinemetrics.com/hubfs/logo_paperless_parts.svg",
            },
          ],
        },
        {
        ...
        <div className="integration-caraousal-main2">
          ...
          <ul style={{ textAlign: "right" }} className="tabs2">
            {this.state.tablist.map((i) => (
              <li
                ...
                className={
                  i.index === this.state.activetab ? "current" : "asdasd"
                }
                style={{ color: "black" }}
              >
                {i.tabItem}
          ...
          <div className="tab-content2 current">
            <div className="tab-content2-left">
              ...
              <p>
                From out-of-the-box, no-code solutions to our build it yourself
                API, it’s never been easier to seamlessly integrate machine
                data-driven insights with your current shop floor systems and
                drive automation.
              </p>
            </div>
              ...
              <div
                className={
                  i.index === this.state.activetab
                    ? "tab-content2-right animated slideInRight"
                    : "tab-content2"
                }
              >
                {i.imageTab.map((p) => (
                  <div className="tab-content2-logo">
                    <img
                      style={{ width: "8.78vw", height: "3.25vw" }}
                      src={p.image}
                      alt=""
                    />
                  </div>
